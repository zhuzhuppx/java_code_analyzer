...
| **项目路径** | /app/working/workspaces/D2GPcF/java_code_analyzer |
| **Java 版本** | unknown |
| **生成时间** | 2026-06-11 10:31:07 |
| **总类数** | 24 |
| **总行数** | 5973 |
...
<div class="stats-grid">
  <div class="stat-card"><div class="stat-value">24</div><div class="stat-label">Java 类</div></div>
  <div class="stat-card"><div class="stat-value">5973</div><div class="stat-label">总行数</div></div>
  <div class="stat-card"><div class="stat-value">339</div><div class="stat-label">方法数</div></div>
  <div class="stat-card"><div class="stat-value">177</div><div class="stat-label">字段数</div></div>
  <div class="stat-card"><div class="stat-value">13.8 行</div><div class="stat-label">平均方法长度</div></div>
  <div class="stat-card"><div class="stat-value">7</div><div class="stat-label">平均复杂度</div></div>
  <div class="stat-card"><div class="stat-value">7</div><div class="stat-label">上帝类</div></div>
...
| `com.projectassistant.chain` | - |
| `com.projectassistant` | `com.projectassistant.web` |
| `com.projectassistant.chat` | - |
| `com.projectassistant.knowledge` | - |
| `com.projectassistant.reporter` | - |
| `com.projectassistant.model` | - |
| `com.projectassistant.spring` | `com.projectassistant.spring` |
| `com.projectassistant.web` | - |
| `com.projectassistant.config` | - |
| `com.projectassistant.scanner` | - |
...
- **全称**: `com.projectassistant.config.ConfigParser`
- **类型**: class
- **行数**: 233
- **包**: `com.projectassistant.config`
- **可见性**: public
...
| private | N | `filePath` | `String` |
| private | N | `type` | `String` |
| private | N | `keyCount` | `int` |
| private | N | `properties` | `return` |

#### 方法 (17)

| 可见性 | 名称 | 返回 | 参数 | 行数 | 复杂度 |
|---|---|---|---|---|---|
| public | `getFilePath()` | `String` | - | 1 | 1 |
| public | `getType()` | `String` | - | 1 | 1 |
| public | `getKeyCount()` | `int` | - | 1 | 1 |
| public | `parse()` | `Map` | - | 1 | 1 |
| private | `findAndParseConfigFiles()` | `void` | - | 1 | 1 |
| private | `parseFile()` | `void` | `Path` | 1 | 4 |
| package-private | `if()` | `else` | `name.endsWith("") ||` | 1 | 3 |
| package-private | `if()` | `else` | `var` | 1 | 2 |
| private | `parseProperties()` | `void` | `String, Path` | 1 | 2 |
| private | `parseYaml()` | `void` | `String, Path` | 1 | 7 |
| package-private | `if()` | `else` | `var` | 1 | 3 |
| private | `parseLogbackXml()` | `void` | `String, Path` | 1 | 2 |
| private | `isKeyConfig()` | `boolean` | `String` | 1 | 2 |
| public | `getSummary()` | `String` | - | 1 | 1 |
| private | `maskPassword()` | `String` | `String` | 1 | 1 |
| public | `getSources()` | `List` | - | 1 | 1 |
| public | `getProperties()` | `Map` | - | 1 | 1 |
...
| private | `calculateHealthScore()` | `int` | - | 1 | 2 |
| private | `architecture()` | `void` | - | 1 | 3 |
| private | `apiCatalog()` | `void` | - | 1 | 5 |
| private | `databaseSchema()` | `void` | - | 1 | 4 |
| private | `beanGraph()` | `void` | - | 1 | 7 |
| private | `capitalize()` | `String` | `String` | 1 | 1 |
...
| public | N | `groupId` | `String` |
| public | N | `artifactId` | `String` |
| public | N | `currentVersion` | `String` |
| public | N | `cve` | `String` |
| public | N | `severity` | `String` |
| public | N | `description` | `String` |
...
| public | `getBeanInfos()` | `List` | - | 1 | 1 |
| public | `getVulnFindings()` | `List` | - | 1 | 1 |
| public | `toString()` | `String` | - | 1 | 1 |
...
- **全称**: `com.projectassistant.scanner.VulnScanner`
- **类型**: class
- **行数**: 146
- **包**: `com.projectassistant.scanner`
- **可见性**: public
...
| 可见性 | 静态 | 名称 | 类型 |
|---|---|---|---|
| private | N | `dependencies` | `List<DependencyInfo>` |
| private | N | `findings` | `return` |
| private | N | `false` | `return` |
| private | N | `groupId` | `String` |
| private | N | `artifactId` | `String` |
| private | N | `affectedRange` | `String` |
| private | N | `cve` | `String` |
| private | N | `severity` | `String` |
| private | N | `description` | `String` |
| public | N | `groupId` | `String` |
| public | N | `artifactId` | `String` |
| public | N | `currentVersion` | `String` |
...
| 可见性 | 名称 | 返回 | 参数 | 行数 | 复杂度 |
|---|---|---|---|---|---|
| public | `scan()` | `List` | - | 1 | 4 |
| private | `isAffected()` | `boolean` | `String, String` | 1 | 2 |
| private | `compareVersions()` | `int` | `String, String` | 1 | 2 |
| private | `parseIntSafe()` | `int` | `String` | 1 | 2 |
| private | `vuln()` | `VulnRule` | `String, String, String, String, String, String` | 1 | 1 |
| public | `getFindings()` | `List` | - | 1 | 1 |
...
| private | N | `requestBodyType` | `String` |
| private | N | `consumes` | `String` |
| private | N | `produces` | `String` |
| private | N | `summary` | `String` |
| private | N | `deprecated` | `boolean` |
| private | N | `name` | `String` |
| private | N | `type` | `String` |
| private | N | `required` | `boolean` |
...
| 可见性 | 名称 | 返回 | 参数 | 行数 | 复杂度 |
|---|---|---|---|---|---|
| public | `getHttpMethod()` | `String` | - | 1 | 3 |
| public | `getPath()` | `String` | - | 1 | 3 |
| public | `getControllerClass()` | `String` | - | 1 | 3 |
| public | `getMethodName()` | `String` | - | 1 | 3 |
| public | `getReturnType()` | `String` | - | 1 | 3 |
| public | `getParameters()` | `List` | - | 1 | 3 |
| public | `getAnnotations()` | `List` | - | 1 | 3 |
| public | `getDescription()` | `String` | - | 1 | 3 |
| public | `isSecured()` | `boolean` | - | 1 | 3 |
| public | `getRequestParams()` | `List` | - | 1 | 3 |
| public | `getPathVariables()` | `List` | - | 1 | 3 |
| public | `getRequestBodyType()` | `String` | - | 1 | 3 |
| public | `getRequestHeaders()` | `List` | - | 1 | 3 |
| public | `getConsumes()` | `String` | - | 1 | 3 |
| public | `getProduces()` | `String` | - | 1 | 3 |
| public | `getSummary()` | `String` | - | 1 | 3 |
| public | `isDeprecated()` | `boolean` | - | 1 | 3 |
| public | `getSignature()` | `String` | - | 1 | 3 |
| public | `toString()` | `String` | - | 1 | 1 |
| public | `getName()` | `String` | - | 1 | 1 |
| public | `getType()` | `String` | - | 1 | 1 |
| public | `isRequired()` | `boolean` | - | 1 | 1 |
...
- **全称**: `com.projectassistant.spring.BeanInfo`
- **类型**: class
- **行数**: 78
- **包**: `com.projectassistant.spring`
- **可见性**: public
...
| 可见性 | 静态 | 名称 | 类型 |
|---|---|---|---|
| private | N | `className` | `String` |
| private | N | `simpleName` | `String` |
| private | N | `beanName` | `String` |
| private | N | `role` | `String` |
| private | N | `scope` | `String` |
| private | N | `isPrimary` | `boolean` |
| private | N | `isLazy` | `boolean` |
| private | N | `fieldName` | `String` |
| private | N | `targetType` | `String` |
| private | N | `targetBeanName` | `String` |
| private | N | `injectionType` | `String` |
| private | N | `annotation` | `String` |
| private | N | `qualifier` | `String` |
...
| public | `getTargetType()` | `String` | - | 1 | 1 |
| public | `getTargetBeanName()` | `String` | - | 1 | 1 |
| public | `getInjectionType()` | `String` | - | 1 | 1 |
| public | `getAnnotation()` | `String` | - | 1 | 1 |
| public | `getQualifier()` | `String` | - | 1 | 1 |
| public | `getClassName()` | `String` | - | 1 | 2 |
| public | `getSimpleName()` | `String` | - | 1 | 2 |
| public | `getBeanName()` | `String` | - | 1 | 2 |
| public | `getRole()` | `String` | - | 1 | 2 |
| public | `getScope()` | `String` | - | 1 | 2 |
| public | `isPrimary()` | `boolean` | - | 1 | 2 |
| public | `isLazy()` | `boolean` | - | 1 | 2 |
| public | `getInjections()` | `List` | - | 1 | 2 |
| public | `getInjectedBy()` | `List` | - | 1 | 2 |
| public | `addInjection()` | `void` | `InjectionPoint` | 1 | 2 |
| public | `addInjectedBy()` | `void` | `String` | 1 | 2 |
...
| private | `hasAnnotation()` | `boolean` | `ClassInfo, String` | 1 | 1 |
| private | `scanControllers()` | `void` | - | 1 | 3 |
| private | `extractClassLevelPath()` | `String` | `ClassInfo` | 1 | 3 |
| private | `scanMethodEndpoint()` | `void` | - | 1 | 5 |
| package-private | `cleanType()` | `pn,` | - | 1 | 1 |
| package-private | `cleanType()` | `pn,` | - | 1 | 1 |
| private | `cleanType()` | `String` | `String` | 1 | 1 |
| private | `isSimpleType()` | `boolean` | `String` | 1 | 1 |
| private | `extractApiSummary()` | `String` | `MethodInfo` | 1 | 2 |
| package-private | `decamelize()` | `return` | `var` | 1 | 1 |
| private | `decamelize()` | `String` | `String` | 1 | 1 |
...
| private | `scanBeanDependencies()` | `void` | - | 1 | 3 |
| private | `detectBeanRole()` | `String` | `ClassInfo` | 1 | 2 |
| private | `registerBean()` | `void` | `ClassInfo, String, String` | 1 | 3 |
| private | `extractBeanName()` | `String` | `ClassInfo` | 1 | 2 |
| private | `resolveFieldInjection()` | `InjectionPoint` | `ClassInfo, FieldInfo` | 1 | 3 |
| private | `resolveBeanForType()` | `String` | `String` | 1 | 3 |
| private | `detectCircularDependencies()` | `void` | - | 1 | 3 |
| private | `hasCycle()` | `boolean` | `String, Set<String>, Set<String>` | 1 | 5 |
| private | `countInjections()` | `int` | - | 1 | 1 |
| private | `scanConfigProperties()` | `void` | - | 1 | 4 |
| public | `getBeanInfoMap()` | `Map` | - | 1 | 1 |
...
- **全称**: `com.projectassistant.sql.SchemaParser`
- **类型**: class
- **行数**: 324
...
|---|---|---|---|
| private | N | `classes` | `List<ClassInfo>` |
| private | N | `xmlFiles` | `List<java.nio.file.Path>` |
| private | N | `tables` | `return` |
| private | N | `col` | `return` |
| private | N | `result` | `return` |
...
| 可见性 | 名称 | 返回 | 参数 | 行数 | 复杂度 |
|---|---|---|---|---|---|
| public | `parse()` | `List` | - | 1 | 1 |
| private | `parseEntityClasses()` | `void` | - | 1 | 4 |
| private | `parseXmlResultMaps()` | `void` | - | 1 | 4 |
| private | `inferTableFromResultMap()` | `String` | `String` | 1 | 2 |
| package-private | `toSnakeCase()` | `return` | `var` | 1 | 1 |
| package-private | `toSnakeCase()` | `return` | `var` | 1 | 1 |
| package-private | `toSnakeCase()` | `return` | `var` | 1 | 1 |
| private | `inferTableName()` | `String` | `ClassInfo` | 1 | 2 |
| package-private | `toSnakeCase()` | `return` | `var` | 1 | 1 |
| private | `parseColumn()` | `TableInfo.Column` | `FieldInfo, ClassInfo` | 1 | 4 |
| private | `mapJavaToSql()` | `String` | `String` | 1 | 1 |
| private | `toSnakeCase()` | `String` | `String` | 1 | 1 |
| private | `findClosingTag()` | `int` | `String, int, String` | 1 | 3 |
| private | `mergeTables()` | `void` | - | 1 | 5 |
...
| private | `scanMyBatisMappers()` | `void` | - | 1 | 5 |
...
- **全称**: `com.projectassistant.web.WebServer`
- **类型**: class
- **行数**: 327
- **包**: `com.projectassistant.web`
- **可见性**: public
...
| 可见性 | 静态 | 名称 | 类型 |
|---|---|---|---|
| private | Y | `currentTask` | `volatile ScanTask` |
| private | Y | `cachedHtml` | `String` |
| private | Y | `chatApiKey` | `volatile String` |

#### 方法 (1)

| 可见性 | 名称 | 返回 | 参数 | 行数 | 复杂度 |
|---|---|---|---|---|---|
| public | `start()` | `void` | `String[]` | 1 | 2 |
...
| 3 | 💩 上帝类 | com.projectassistant.model.ProjectModel 有 22 个方法 | 建议拆分为多个职责单一的类 |
| 4 | 💩 上帝类 | com.projectassistant.spring.ApiEndpoint 有 25 个方法 | 建议拆分为多个职责单一的类 |
| 5 | 💩 上帝类 | com.projectassistant.spring.SpringScanner 有 35 个方法 | 建议拆分为多个职责单一的类 |
...
| 2 | 💩 大类别 | com.projectassistant.knowledge.KnowledgeBaseGenerator 有 841 行 | 建议拆分为多个小类 |
| 3 | 💩 大类别 | com.projectassistant.scanner.ProjectScanner 有 808 行 | 建议拆分为多个小类 |
| 4 | 💩 大类别 | com.projectassistant.spring.SpringScanner 有 560 行 | 建议拆分为多个小类 |
| 5 | 低内聚 | ProjectAnalyzer 内聚度=0.00（仅 0/26 方法访问字段） | 方法不操作类字段，考虑是否应该放在其它类中 |
| 6 | 低内聚 | CallChain 内聚度=0.00（仅 0/6 方法访问字段） | 方法不操作类字段，考虑是否应该放在其它类中 |
| 7 | 低内聚 | CallChainAnalyzer 内聚度=0.00（仅 0/5 方法访问字段） | 方法不操作类字段，考虑是否应该放在其它类中 |
| 8 | 低内聚 | ConfigParser 内聚度=0.00（仅 0/17 方法访问字段） | 方法不操作类字段，考虑是否应该放在其它类中 |
| 9 | 低内聚 | KnowledgeBaseGenerator 内聚度=0.00（仅 0/19 方法访问字段） | 方法不操作类字段，考虑是否应该放在其它类中 |
| 10 | 低内聚 | Main 内聚度=0.00（仅 0/2 方法访问字段） | 方法不操作类字段，考虑是否应该放在其它类中 |
| 11 | 低内聚 | ClassInfo 内聚度=0.00（仅 0/21 方法访问字段） | 方法不操作类字段，考虑是否应该放在其它类中 |
| 12 | 低内聚 | DependencyInfo 内聚度=0.00（仅 0/8 方法访问字段） | 方法不操作类字段，考虑是否应该放在其它类中 |
| 13 | 低内聚 | FieldInfo 内聚度=0.00（仅 0/9 方法访问字段） | 方法不操作类字段，考虑是否应该放在其它类中 |
| 14 | 低内聚 | MethodInfo 内聚度=0.00（仅 0/19 方法访问字段） | 方法不操作类字段，考虑是否应该放在其它类中 |
| 15 | 低内聚 | ModuleInfo 内聚度=0.00（仅 0/7 方法访问字段） | 方法不操作类字段，考虑是否应该放在其它类中 |
| 16 | 低内聚 | ProjectModel 内聚度=0.00（仅 0/22 方法访问字段） | 方法不操作类字段，考虑是否应该放在其它类中 |
| 17 | 低内聚 | ProjectStats 内聚度=0.00（仅 0/19 方法访问字段） | 方法不操作类字段，考虑是否应该放在其它类中 |
| 18 | 低内聚 | ReportGenerator 内聚度=0.00（仅 0/19 方法访问字段） | 方法不操作类字段，考虑是否应该放在其它类中 |
| 19 | 低内聚 | ProjectScanner 内聚度=0.00（仅 0/13 方法访问字段） | 方法不操作类字段，考虑是否应该放在其它类中 |
| 20 | 低内聚 | VulnScanner 内聚度=0.17（仅 1/6 方法访问字段） | 方法不操作类字段，考虑是否应该放在其它类中 |
| 21 | 低内聚 | ApiEndpoint 内聚度=0.00（仅 0/25 方法访问字段） | 方法不操作类字段，考虑是否应该放在其它类中 |
| 22 | 低内聚 | BeanInfo 内聚度=0.06（仅 1/17 方法访问字段） | 方法不操作类字段，考虑是否应该放在其它类中 |
| 23 | 低内聚 | SpringScanner 内聚度=0.00（仅 0/35 方法访问字段） | 方法不操作类字段，考虑是否应该放在其它类中 |
| 24 | 低内聚 | SchemaParser 内聚度=0.00（仅 0/15 方法访问字段） | 方法不操作类字段，考虑是否应该放在其它类中 |
| 25 | 低内聚 | SqlParser 内聚度=0.00（仅 0/12 方法访问字段） | 方法不操作类字段，考虑是否应该放在其它类中 |
| 26 | 低内聚 | TableInfo 内聚度=0.00（仅 0/16 方法访问字段） | 方法不操作类字段，考虑是否应该放在其它类中 |
| 27 | 低内聚 | WebServer 内聚度=0.00（仅 0/1 方法访问字段） | 方法不操作类字段，考虑是否应该放在其它类中 |

### 改进建议 (19)

| # | 分类 | 描述 | 建议 |
|---|---|---|---|
| 1 | 架构分层 | 架构分层概览:<br>  - Entity/Domain 层: 1 个包<br>  - Config/Util 层: 1 个包<br>  - 其他: 9 个包<br>  - Controller/API 层: 1 个包<br> | 清晰的层次结构有助于维护和扩展 |
...
| 6 | 可能的未使用方法 | KnowledgeBaseGenerator.saveSkill() 在项目内部未被调用 | 考虑删除或标记为 @Deprecated |
| 7 | 可能的未使用方法 | Main.main() 在项目内部未被调用 | 考虑删除或标记为 @Deprecated |
| 8 | 可能的未使用方法 | DependencyInfo.toGav() 在项目内部未被调用 | 考虑删除或标记为 @Deprecated |
| 9 | 可能的未使用方法 | ReportGenerator.generateMarkdown() 在项目内部未被调用 | 考虑删除或标记为 @Deprecated |
| 10 | 可能的未使用方法 | ReportGenerator.generateHtml() 在项目内部未被调用 | 考虑删除或标记为 @Deprecated |
| 11 | 可能的未使用方法 | ReportGenerator.saveReport() 在项目内部未被调用 | 考虑删除或标记为 @Deprecated |
| 12 | 可能的未使用方法 | ProjectScanner.scan() 在项目内部未被调用 | 考虑删除或标记为 @Deprecated |
| 13 | 可能的未使用方法 | VulnScanner.scan() 在项目内部未被调用 | 考虑删除或标记为 @Deprecated |
| 14 | 可能的未使用方法 | BeanInfo.addInjectedBy() 在项目内部未被调用 | 考虑删除或标记为 @Deprecated |
| 15 | 可能的未使用方法 | SpringScanner.scan() 在项目内部未被调用 | 考虑删除或标记为 @Deprecated |
| 16 | 可能的未使用方法 | SqlParser.scan() 在项目内部未被调用 | 考虑删除或标记为 @Deprecated |
| 17 | 可能的未使用方法 | SqlParser.hasMyBatis() 在项目内部未被调用 | 考虑删除或标记为 @Deprecated |
| 18 | 可能的未使用方法 | SqlParser.hasJPA() 在项目内部未被调用 | 考虑删除或标记为 @Deprecated |
| 19 | 待办事项 | 项目中共有 24 处 TODO/FIXME | 定期清理待办事项，避免技术债务累积 |

### 信息提示 (1)

| # | 分类 | 描述 | 建议 |
|---|---|---|---|
| 1 | Public API 规模 | 项目共有 215 个 public 方法 | public API 是项目的对外契约，变更需谨慎 |
