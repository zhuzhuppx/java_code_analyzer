...
<div class="stats-grid">
  ...
  <div class="stat-card"><div class="stat-value">4072</div><div class="stat-label">总行数</div></div>
  ...
  <div class="stat-card"><div class="stat-value">12.7 行</div><div class="stat-label">平均方法长度</div></div>
...
| 2 | 💩 大类别 | com.projectassistant.knowledge.KnowledgeBaseGenerator 有 599 行 | 建议拆分为多个小类 |
